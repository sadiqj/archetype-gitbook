...
{% hint style="info" %}
The view above is generated by [obelisk](https://github.com/Lelio-Brun/Obelisk) from [parser.mly](https://github.com/edukera/archetype-lang/blob/master/src/parser.mly)
{% endhint %}
