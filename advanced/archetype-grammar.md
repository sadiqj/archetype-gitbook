...
<archetype> ::= ARCHETYPE [<extensions>] <ident> <parameters>

<parameters> ::= [<loc(<parameters_unloc>)>]

<parameters_unloc> ::= LPAREN <snl(COMMA, <parameter>)> RPAREN

<parameter> ::= <loc(<parameter_unloc>)>

<parameter_unloc> ::= [CONST] <ident> COLON <type_t> [<parameter_init>]

<parameter_init> ::= EQUAL <simple_expr>
...
<type_decl> ::= TYPE <ident> EQUAL <type_t>

<enum> ::= STATES [<extensions>] [<prefix(EQUAL, <enum_body>)>]
         | ENUM [<extensions>] <ident> [<prefix(EQUAL, <enum_body>)>]

<enum_body> ::= <enum_cdecl>*

<enum_cdecl> ::= PIPE <ident> [<prefix(OF, <type_s> (MULT <type_s>)*)>]
                 <enum_option>*
...
<type_t> ::= <loc(<type_r>)>
           | LPAREN <loc(<type_r>)> <loc(PIDENT)> RPAREN
...
<type_s_unloc> ::= <ident>
                 ...
                 | BIG_MAP LESS <type_t> COMMA <type_s> GREATER
                 | OR LESS <type_t> COMMA <type_s> GREATER
                 | LAMBDA LESS <type_t> COMMA <type_s> GREATER
                 | CONTRACT LESS <type_t> GREATER
                 | TICKET LESS <type_t> GREATER
                 | SAPLING_STATE <paren(NUMBERNAT)>
                 | SAPLING_TRANSACTION <paren(NUMBERNAT)>
                 | <paren(<type_r>)>
...
<transition> ::= TRANSITION [<extensions>] <ident> <function_args>
                 [<on_value>] LBRACE <entry_properties> FROM <simple_expr>
                 <transitions> RBRACE
...
<pattern> ::= PIPE <pattern_r>

<pattern_r> ::= UNDERSCORE
              | <loc(<pname>)> <ident>
              | <loc(<pname>)> [<paren(<ident> (COMMA <ident>)*)>]
              | LBRACKET RBRACKET
              | <ident> <loc(COLONCOLON)> <ident>
...
<expr_r> ::= LPAREN RPAREN
           ...
           | <paren(<snl2(COMMA, <expr>)>)>
           | <expr> <assignment_operator_expr> <expr>
           | TRANSFER <simple_expr>
...
<simple_expr_r> ::= MATCH <expr> WITH <branchs> END
                  | FOLD LPAREN <expr> COMMA <ident> IMPLY <expr> RPAREN
                  | MAP LPAREN <expr> COMMA <ident> IMPLY <expr> RPAREN
                  | <ident> <app_args>
                  ...
                  | NONE
                  | NONE LESS <type_t> GREATER
                  | LEFT LESS <type_t> GREATER <paren(<expr>)>
                  | LEFT LESS UNDERSCORE COMMA <type_t> GREATER
                    <paren(<expr>)>
                  | LEFT LESS <type_t> COMMA <type_t> GREATER <paren(<expr>)>
                  | RIGHT LESS <type_t> GREATER <paren(<expr>)>
                  | RIGHT LESS <type_t> COMMA UNDERSCORE GREATER
                    <paren(<expr>)>
                  | RIGHT LESS <type_t> COMMA <type_t> GREATER
                    <paren(<expr>)>
                  | LAMBDA LESS <type_t> GREATER LPAREN LPAREN <ident> COLON
                    <type_t> RPAREN IMPLY <expr> RPAREN
                  | LAMBDA LESS <type_t> GREATER LPAREN <ident> IMPLY <expr>
                    RPAREN
                  | LAMBDA LPAREN LPAREN <ident> COLON <type_t> RPAREN IMPLY
                    <expr> RPAREN
                  | LAMBDA LPAREN <ident> IMPLY <expr> RPAREN
                  | UNPACK LESS <type_t> GREATER <paren(<expr>)>
                  | SELF DOT <ident>
                  | ENTRYPOINT LESS <type_t> GREATER LPAREN <expr> COMMA
                    <expr> RPAREN
                  | ANY
                  | INVALID_EXPR
                  | <paren(<block_r>)>
