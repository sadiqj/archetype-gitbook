...
<dextension> ::= PERCENT <ident> [<simple_expr>]

<extensions> ::= <extension>+

<extension> ::= <loc(<extension_r>)>

<extension_r> ::= LBRACKETPERCENT <ident> [<simple_expr>] PERCENTRBRACKET
...
<spec_effect> ::= SHADOW EFFECT <braced(<expr>)>
...
<transition> ::= TRANSITION [<extensions>] <ident> <function_args>
                 [<on_value>] FROM <expr> LBRACE <action_properties>
                 <transitions> RBRACE
...
<expr_r> ::= LPAREN RPAREN
           ...
           | LABEL <ident>
           | BREAK
           | FOR <colon_ident> <ident> IN <expr> DO <expr> DONE
           | ITER <colon_ident> <ident> <from_expr> TO <expr> DO <expr> DONE
           | IF <expr> THEN <expr>
